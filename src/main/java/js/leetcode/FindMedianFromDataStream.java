...
public class FindMedianFromDataStream extends LeetCode {
  ...
  class MedianFinder {
    ...
    private void shiftMedianLow() {
      ...
      System.arraycopy(midBucket.array, 0, newMidArray, SHIFT_COUNT, midBucket.size() - SHIFT_COUNT);
    ...
    private void shiftMedianHigh() {
      ...
      System.arraycopy(midBucket.array, SHIFT_COUNT, newMidArray, 0, midBucket.size() - SHIFT_COUNT);
      System.arraycopy(highBucket.array, 0, newMidArray, midBucket.size() - SHIFT_COUNT, SHIFT_COUNT);
